...
def endGame(playerName, rightOrWrong):
    waitingDots()
    typeOut(
        'Before you know it, your captors are made of your presence. You take off immediately, into a long, long tunnel, and--',
        0.1)
    spinningIcon()
...
while restart == 'yes' or restart == 'y':
    ...
    for scene in sceneList:
        ...
        if scene == scene1:
            passCount = 0
            typeOut(
                'Your actions change nothing. The room is devoid of any loose objects or potential tools. There are no other sounds but your own. Time goes by. There’s nothing left to do... but sleep...',
                0.1)
            waitingDots()
